...
public class AresDbTableLayoutHandle
        implements ConnectorTableLayoutHandle
{
    private final AresDbTableHandle table;
    private final Optional<TupleDomain<ColumnHandle>> constraint;
    private final Optional<TableScanPipeline> scanPipeline;

    @JsonCreator
    public AresDbTableLayoutHandle(
            @JsonProperty("table") AresDbTableHandle table,
    ...
    @JsonProperty
    public AresDbTableHandle getTable()
    {
        return table;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        AresDbTableLayoutHandle that = (AresDbTableLayoutHandle) o;
    ...
    public String toString()
    {
        ...
        if (scanPipeline.isPresent()) {
            result.append(", aql=" + AresDbQueryGenerator.generate(scanPipeline.get(), Optional.empty(), Optional.empty()));
        }
